...
htmxpatterns = [
 ...
 path('icn_add_disaggregate/<int:id>/', views.add_disaggregate, name='icn_add_disaggregate'),
 path('activity_add_disaggregate/<int:id>/', views.add_activity_disaggregate, name='activity_add_disaggregate'),
 path('icn_edit_disaggregate/<int:pk>/', views.edit_disaggregate, name='icn_edit_disaggregate'),
 path('activity_edit_disaggregate/<int:pk>/', views.edit_activity_disaggregate, name='activity_edit_disaggregate'),
 path('icn_delete_disaggregate/<int:pk>/', views.delete_disaggregate, name='icn_delete_disaggregate'),
 path('activity_delete_disaggregate/<int:pk>/', views.delete_activity_disaggregate, name='activity_delete_disaggregate'),
