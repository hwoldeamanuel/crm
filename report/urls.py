...
htmxpatterns = [
 ...
 path('add_impact_dis/<int:id>/', views.add_icnreport_impact_dis, name='add_icnreport_impact_dis'),
 path('edit_impact_dis/<int:pk>/', views.edit_icnreport_impact_dis, name='edit_icnreport_impact_dis'),
 path('delete_impact_dis/<int:pk>/', views.delete_icnreport_impact_dis, name='delete_icnreport_impact_dis'),
